...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.95\linewidth]{figures_v5/fig1_architecture.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.95\linewidth]{figures_v5/fig2_pt_gaussian.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.95\linewidth]{figures_v5/fig3_risk_scene.png}
\caption{Risk-Scene Generation via Monotone Transport. PT quantile transport closely matches target Beta mixture $G = 0.85 \cdot {\rm Beta}(2,12) + 0.15 \cdot {\rm Beta}(8,2)$ with $W_1 = 0.0044$, compared to $W_1 = 0.0933$ for Gaussian mapping.}
\label{fig:risk_scene}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.95\linewidth]{figures_v5/fig4_exploration.png}
\caption{Exploration Noise on 20-Arm Structured Bandit. PT-OT exploration achieves cumulative reward 248.84 vs. 230.46 for Gaussian, with best-arm discovery rate 43\% vs. 21\%. PT concentrates mass on small perturbations while preserving controlled tail of large jumps.}
...
\midrule
Uniform & 0.949$\pm$0.012 & 0.529$\pm$0.031 & 0.806$\pm$0.018 & 0.504$\pm$0.028 \\
Inv-Freq & 0.930$\pm$0.015 & 0.602$\pm$0.028 & 0.768$\pm$0.016 & 0.564$\pm$0.024 \\
Focal Loss & 0.947$\pm$0.011 & 0.541$\pm$0.029 & 0.815$\pm$0.017 & 0.529$\pm$0.026 \\
DRO & 0.941$\pm$0.014 & 0.548$\pm$0.027 & 0.813$\pm$0.019 & 0.541$\pm$0.025 \\
Meta-Weight & 0.945$\pm$0.012 & 0.552$\pm$0.026 & 0.819$\pm$0.017 & 0.547$\pm$0.024 \\
\textbf{PT-rank} & \textbf{0.949$\pm$0.010} & \textbf{0.565$\pm$0.025} & \textbf{0.818$\pm$0.015} & \textbf{0.548$\pm$0.022} \\
\bottomrule
\end{tabular}
\end{table}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.95\linewidth]{figures_v5/fig5_mt10_results.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.95\linewidth]{figures_v5/fig6_ablation.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.95\linewidth]{figures_v5/fig7_real_hardware.png}
